...
if (NOT DEFINED VCPKG_TARGET_TRIPLET)
    if (DEFINED ENV{VCPKG_DEFAULT_TRIPLET})
        ...
        if (CMAKE_SYSTEM_NAME STREQUAL "Windows")
            ...
            set(SIMH_PLATFORM ${CMAKE_GENERATOR_PLATFORM})
            if("${SIMH_PLATFORM}" STREQUAL "")
                set(SIMH_PLATFORM ${CMAKE_SYSTEM_PROCESSOR})
            endif()
            if(SIMH_PLATFORM MATCHES "[Ww][Ii][Nn]32")
                set(SIMH_VCPKG_ARCH "x86")
            elseif(SIMH_PLATFORM MATCHES "[Aa][Rr][Mm]64")
                set(SIMH_VCPKG_ARCH "arm64")
            elseif(SIMH_PLATFORM MATCHES "[Aa][Rr][Mm]")
                set(SIMH_VCPKG_ARCH "arm")
            else()
                message(STATUS "SIMH_PLATFORM (${SIMH_PLATFORM}) not recognized, defaulting to x64")
            endif()
